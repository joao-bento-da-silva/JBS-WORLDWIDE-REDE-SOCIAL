...
conn = conectar_banco()
c = conn.cursor()
c.execute('''CREATE TABLE IF NOT EXISTS usuarios (id INTEGER PRIMARY KEY AUTOINCREMENT, nome TEXT NOT NULL, email TEXT UNIQUE NOT NULL, senha TEXT NOT NULL, pontos INTEGER DEFAULT 0, data_cadastro DATETIME DEFAULT CURRENT_TIMESTAMP)''')
c.execute('''CREATE TABLE IF NOT EXISTS postagens (id INTEGER PRIMARY KEY AUTOINCREMENT, usuario_id INTEGER, texto TEXT, arquivo TEXT, tipo_arquivo TEXT, curtidas INTEGER DEFAULT 0, data DATETIME DEFAULT CURRENT_TIMESTAMP)''')
c.execute('''CREATE TABLE IF NOT EXISTS curtidas (id INTEGER PRIMARY KEY AUTOINCREMENT, postagem_id INTEGER, usuario_id INTEGER)''')
conn.commit()
conn.close()
...
def inicio():
    ...
    return render_template_string('''<!DOCTYPE html><html><head><meta charset="UTF-8"><title>JNB TECNOLOGIA</title></head><body style="background:#0f172a;color:white;padding:20px;text-align:center;"><h1 style="color:#84cc16;">JNB TECNOLOGIA</h1><a href="/documentos" style="display:block;max-width:400px;margin:10px auto;padding:15px;background:#1e293b;border:2px solid #84cc16;border-radius:10px;color:white;text-decoration:none;">📄 Documentos</a><a href="/projetos" style="display:block;max-width:400px;margin:10px auto;padding:15px;background:#1e293b;border:2px solid #84cc16;border-radius:10px;color:white;text-decoration:none;">📐 Projetos</a><a href="/anuncios" style="display:block;max-width:400px;margin:10px auto;padding:15px;background:#1e293b;border:2px solid #84cc16;border-radius:10px;color:white;text-decoration:none;">📢 Anuncios</a><a href="/inteligencia_dna" style="display:block;max-width:400px;margin:10px auto;padding:15px;background:#1e293b;border:2px solid #84cc16;border-radius:10px;color:white;text-decoration:none;">🧬 DNA JNB</a><a href="/rede_social" style="display:block;max-width:400px;margin:10px auto;padding:15px;background:#1e293b;border:2px solid #84cc16;border-radius:10px;color:white;text-decoration:none;">🌐 Rede Social</a><a href="/inteligencia" style="display:block;max-width:400px;margin:10px auto;padding:15px;background:#1e293b;border:2px solid #84cc16;border-radius:10px;color:white;text-decoration:none;">🧠 Inteligencia</a><a href="/jogo_pares" style="display:block;max-width:400px;margin:10px auto;padding:15px;background:#1e293b;border:2px solid #84cc16;border-radius:10px;color:white;text-decoration:none;">🎮 Jogo dos Pares</a><a href="/loja_premios" style="display:block;max-width:400px;margin:10px auto;padding:15px;background:#1e293b;border:2px solid #84cc16;border-radius:10px;color:white;text-decoration:none;">🏆 Loja de Premios</a><a href="/cadastrar" style="display:block;max-width:400px;margin:10px auto;padding:15px;background:#84cc16;color:black;font-weight:bold;border-radius:10px;text-decoration:none;">Criar Conta</a></body></html>''')
...
def painel():
    ...
    return render_template_string('''<html><body style="background:#0f172a;color:white;padding:20px;text-align:center;"><h1>Bem-vindo, ''' + nome + '''!</h1><h3>Pontos: ''' + str(pontos) + '''</h3><a href="/documentos" style="display:inline-block;padding:10px 20px;margin:5px;background:#1e293b;border:2px solid #84cc16;border-radius:8px;color:white;text-decoration:none;">📄 Documentos</a><a href="/projetos" style="display:inline-block;padding:10px 20px;margin:5px;background:#1e293b;border:2px solid #84cc16;border-radius:8px;color:white;text-decoration:none;">📐 Projetos</a><a href="/anuncios" style="display:inline-block;padding:10px 20px;margin:5px;background:#1e293b;border:2px solid #84cc16;border-radius:8px;color:white;text-decoration:none;">📢 Anuncios</a><br><a href="/inteligencia_dna" style="display:inline-block;padding:10px 20px;margin:5px;background:#1e293b;border:2px solid #84cc16;border-radius:8px;color:white;text-decoration:none;">🧬 DNA JNB</a><a href="/rede_social" style="display:inline-block;padding:10px 20px;margin:5px;background:#1e293b;border:2px solid #84cc16;border-radius:8px;color:white;text-decoration:none;">🌐 Rede Social</a><a href="/inteligencia" style="display:inline-block;padding:10px 20px;margin:5px;background:#1e293b;border:2px solid #84cc16;border-radius:8px;color:white;text-decoration:none;">🧠 Inteligencia</a><br><a href="/jogo_pares" style="display:inline-block;padding:10px 20px;margin:5px;background:#1e293b;border:2px solid #84cc16;border-radius:8px;color:white;text-decoration:none;">🎮 Jogo dos Pares</a><a href="/loja_premios" style="display:inline-block;padding:10px 20px;margin:5px;background:#1e293b;border:2px solid #84cc16;border-radius:8px;color:white;text-decoration:none;">🏆 Loja de Premios</a><br><br><a href="/sair" style="color:#ef4444;">Sair</a></body></html>''')
...
def projetos():
    ...
    # ==================================================
# © 2026 JNB TECNOLOGIA — DNA DIGITAL / B.N.J.
# SISTEMA COMPLETO DE ANÁLISE E VERIFICAÇÃO
# SEQUÊNCIA · PAR CORRESPONDENTE · BINÁRIO · HEXADECIMAL
# MEDIÇÃO DE CAPACIDADE · DETECÇÃO DE INTEGRIDADE E FALHAS
# ==================================================
...
def bnj():
    ...
    # 🧬 SEQUÊNCIAS DNA — PAR ORIGINAL ↔ CORRESPONDENTE
    ...
    def converter_sequencia(seq):
        """Converte sequência em Binário e Hexadecimal"""
    ...
    <head>
        ...
        <title>DNA DIGITAL B.N.J. — Sistema Completo</title>
        <style>
    ...
    <body>
        <div class="painel">
            ...
            <div class="grade">
                <div class="caixa">
                    <div class="etq">Original · Binário</div>
                    <div class="val">{analise['bin_ori']}</div>
                </div>
                <div class="caixa">
                    <div class="etq">Original · Hexadecimal</div>
                    <div class="val">{analise['hex_ori']}</div>
                </div>
                <div class="caixa">
                    <div class="etq">Par · Binário</div>
                    <div class="val">{analise['bin_par']}</div>
                </div>
                <div class="caixa">
                    <div class="etq">Par · Hexadecimal</div>
                    <div class="val">{analise['hex_par']}</div>
                </div>
            </div>
